    ...
    examples: [
      {
        ...
        steps: [
          "$\\nabla\\phi = (2x, 2y, -1) = (2, 2, -1)$ at the point.",
          "$|\\nabla\\phi| = 3$, hence $$\\boxed{\\hat n = \\tfrac{1}{3}(2, 2, -1).}$$",
        ],
      },
      {
        problem: "Find the directional derivative of $\\phi = x^2 y z$ at $(1, 2, 3)$ in the direction of $\\vec a = \\hat i + 2\\hat j + 2\\hat k$.",
        steps: [
          "$\\nabla\\phi = (2 x y z,\\, x^2 z,\\, x^2 y) = (12, 3, 2)$ at the point.",
          "$\\hat a = \\tfrac{1}{3}(1, 2, 2)$.",
          "$\\nabla\\phi\\cdot \\hat a = \\tfrac{1}{3}(12 + 6 + 4) = \\tfrac{22}{3}$.",
          "$$\\boxed{\\,\\dfrac{d\\phi}{ds} = \\tfrac{22}{3}.\\,}$$",
        ],
      },
    ],
    practice: [
    ...
    examples: [
      {
        ...
        steps: [
          "$\\nabla\\phi_1 = (2x, 2y, 2z) = (4, -2, 4)$.",
          "$\\nabla\\phi_2 = (2x, 2y, -1) = (4, -2, -1)$.",
          "$\\cos\\theta = \\dfrac{(4)(4) + (-2)(-2) + (4)(-1)}{\\sqrt{36}\\sqrt{21}} = \\dfrac{16}{6\\sqrt{21}} = \\dfrac{8}{3\\sqrt{21}}$.",
          "$$\\boxed{\\,\\theta = \\cos^{-1}\\!\\dfrac{8}{3\\sqrt{21}}.\\,}$$",
        ],
      },
    ],
    practice: [
    ...
    examples: [
      {
        ...
        steps: [
          "$\\operatorname{div} = 2 x + 2 y + 2 z = 2(x + y + z)$.",
          "$\\operatorname{curl} = (-x - (-x), -(-y) - (-y), -z - (-z)) = (0, 0, 0)$.",
          "$$\\boxed{\\,\\operatorname{div}\\vec F = 2(x+y+z),\\quad \\operatorname{curl}\\vec F = \\vec 0.\\,}$$",
        ],
      },
      {
        problem: "Show that $\\vec F = (2 x y + z^3)\\hat i + x^2\\hat j + 3 x z^2 \\hat k$ is irrotational and find its scalar potential $\\phi$.",
        steps: [
          "Compute $\\operatorname{curl}\\vec F$: each component evaluates to $0$. ✓",
          "$\\partial\\phi/\\partial x = 2 x y + z^3 \\Rightarrow \\phi = x^2 y + x z^3 + g(y, z)$.",
          "$\\partial\\phi/\\partial y = x^2 + g_y = x^2 \\Rightarrow g_y = 0$.",
          "$\\partial\\phi/\\partial z = 3 x z^2 + g_z = 3 x z^2 \\Rightarrow g_z = 0 \\Rightarrow g = \\text{const}$.",
    ...
    examples: [
      {
        ...
        steps: [
          ...
          "Curl component $i$: $\\partial_y\\phi_z - \\partial_z\\phi_y = \\phi_{zy} - \\phi_{yz} = 0$ (by Clairaut).",
          "Similarly the other components vanish. $\\blacksquare$",
        ],
      },
      {
        problem: "If $\\vec r = (x, y, z),\\; r = |\\vec r|$, evaluate $\\operatorname{div}(r^n \\vec r)$.",
        steps: [
          "$\\operatorname{div}(\\phi\\vec F) = \\phi\\,\\operatorname{div}\\vec F + \\nabla\\phi\\cdot\\vec F$ with $\\phi = r^n,\\; \\vec F = \\vec r$.",
          "$\\operatorname{div}\\vec r = 3,\\; \\nabla r^n = n r^{n-2}\\vec r,\\; \\nabla r^n\\cdot\\vec r = n r^n$.",
          "$$\\boxed{\\,\\operatorname{div}(r^n \\vec r) = (n + 3) r^n.\\,}$$",
        ],
      },
    ],
    practice: [
